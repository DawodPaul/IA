...
class Joc:
    ...
    # TO DO 3,6
    def mutari(self, jucator):  # jucator = simbolul jucatorului care muta  DA MUTARILE POSIBILE!!!!!!
        l_mutari = []
    ...
    def estimeaza_scor(self, adancime):
       ...
       # print('t_final:',t_final)
        if t_final == self.__class__.JMAX:  # self.__class__ referinta catre clasa instantei
            #print('t_final:', t_final,' class_JMAX',self.__class__.JMAX,adancime)
            return (99 + adancime)
...
class Stare:
    ...
    def mutari(self):
       ...
       # print('l_mutari=',l_mutari)# lista de informatii din nodurile succesoare
        juc_opus = Joc.jucator_opus(self.j_curent)
       # print('juc_opus=',juc_opus)
...
def afis_daca_final(stare_curenta):
    final = stare_curenta.tabla_joc.final()  # metoda final() returneaza "remiza" sau castigatorul ("x" sau "0") sau
